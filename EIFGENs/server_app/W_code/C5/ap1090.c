...
extern void F1090_8944(EIF_REFERENCE);
...
void F1090_8944 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1089, Current, 2, 0, 14976);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1089, Current, 14976);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ur1 = tr1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(6663, "import_ini_file_options", loc2))(loc2, ur1x);
	RTHOOK(3);
	RTDBGAL(Current, 1, 0xF8000488, 0, 0); /* loc1 */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1160,0xFF01,1085,0xFFFF};
		EIF_TYPE typres0;
