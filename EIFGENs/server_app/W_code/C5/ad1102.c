...
extern void F1102_9151(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ADDRINFO_2}.c_free */
void F1102_9151 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1101, Current, 0, 1, 15180);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
