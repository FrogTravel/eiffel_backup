...
extern EIF_TYPED_VALUE F1119_9538(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1119_9538 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1118, Current, 0, 0, 15585);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1118, Current, 15585);
	RTIV(Current, RTAL);
	RTHOOK(1);
