...
static const EIF_TYPE_INDEX egt_13_1112 [] = {0xFF01,1117,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1112 [] = {0xFF01,224,0xFFFF};
...
static const struct desc_info desc_1112[] = {
	...
	{EIF_GENERIC(egt_13_1112), 15435, 0},
	{EIF_NON_GENERIC(0x0881 /*1088*/), 15436, 8},
	{EIF_GENERIC(NULL), 15438, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1112), 15437, 0xFFFFFFFF},
};
void Init1112(void)
{
	IDSC(desc_1112, 0, 1111);
	IDSC(desc_1112 + 1, 1, 1111);
	IDSC(desc_1112 + 32, 489, 1111);
	IDSC(desc_1112 + 36, 349, 1111);
}
