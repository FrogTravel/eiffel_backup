...
extern void F1113_9417(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1113_9418(EIF_REFERENCE);
...
extern void F1113_10174(EIF_REFERENCE, int);
...
void F1113_9417 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1112, Current, 0, 2, 15438);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1112, Current, 15438);
	RTCC(arg1, 1112, l_feature_name, 1, RTWCT(6940, dtype, Dftype(Current)), 0x00);
	RTCC(arg2, 1112, l_feature_name, 2, RTWCT(6941, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6940, 0xF800045E, 0); /* mapping */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(6940, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(2);
	ur1 = RTCCL(arg2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6942, dtype))(Current, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
EIF_TYPED_VALUE F1113_9418 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1112, Current, 3, 0, 15441);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1112, Current, 15441);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF80000E9, 0, 0); /* loc1 */
	tr1 = RTLN(eif_new_type(233, 0x01).id);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6940, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1112, Current, 0, 1, 15442);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1112, Current, 15442);
	RTCC(arg1, 1112, l_feature_name, 1, RTWCT(6941, Dtype(Current), Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 6941, 0xF8000440, 0); /* request_methods */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(6941, Dtype(Current))) = (EIF_REFERENCE) RTCCL(arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F1113_10174 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1112, Current, 0, 10173);
	RTSA(dtype);
	RTME(dtype, 0);
