...
extern void F1094_9058(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1094_9058 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(6658, dtype))(Current);
	RTHOOK(2);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6680, dtype))(Current, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1093, Current, 0, 2, 15089);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTCC(arg1, 1093, l_feature_name, 1, eif_new_type(224, 0x01), 0x01);
	if (arg2) {
		RTCC(arg2, 1093, l_feature_name, 2, eif_new_type(1092, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(6658, dtype))(Current);
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1093, Current, 4, 1, 15090);
	RTSA(Dtype(Current));
	RTSC;
	...
	if (tb1) {
		...
		for (;;) {
			RTHOOK(5);
			tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1792, "exhausted", loc1))(loc1)).it_b);
			if (tb1) break;
			RTHOOK(6);
			...
			RTHOOK(7);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(4507, "left_adjust", loc2))(loc2);
			RTHOOK(8);
			tb2 = '\0';
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4387, "is_empty", loc2))(loc2)).it_b);
			if ((EIF_BOOLEAN) !tb3) {
			...
			if (tb2) {
				...
				if ((EIF_BOOLEAN) (loc4 > ((EIF_INTEGER_32) 1L))) {
					...
					RTHOOK(12);
					ui4_1 = (EIF_INTEGER_32) (loc4 - ((EIF_INTEGER_32) 1L));
					(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4505, "keep_head", loc2))(loc2, ui4_1x);
					RTHOOK(13);
					...
					RTHOOK(15);
					(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(4508, "right_adjust", loc2))(loc2);
					RTHOOK(16);
					tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4431, "as_lower", loc2))(loc2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
					ur1 = RTCCL(tr1);
					ur2 = RTCCL(loc3);
					(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(6671, Dtype(Current)))(Current, ur1x, ur2x);
				}
			}
			RTHOOK(17);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(3351, "read_line", loc1))(loc1);
