...
extern void F1095_9062(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1095_9063(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1095_9064(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1095_9062 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1094, Current, 0, 1, 15092);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1094, Current, 15092);
	RTCC(arg1, 1094, l_feature_name, 1, eif_new_type(224, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1095_9063 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1094, Current, 0, 2, 15093);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTCC(arg1, 1094, l_feature_name, 1, eif_new_type(224, 0x01), 0x01);
	if (arg2) {
		RTCC(arg2, 1094, l_feature_name, 2, eif_new_type(1093, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(6662, dtype))(Current);
...
void F1095_9064 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1094, Current, 4, 1, 15094);
	RTSA(Dtype(Current));
	RTSC;
