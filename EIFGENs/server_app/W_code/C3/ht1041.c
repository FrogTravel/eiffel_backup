...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1040, Current, 0, 1, 14092);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5717, dtype))(Current)).it_i4);
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1040, Current, 0, 1, 14093);
	RTSA(Dtype(Current));
	RTSC;
