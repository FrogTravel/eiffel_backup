...
extern EIF_TYPED_VALUE F1023_7785(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1023_7785 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1022, Current, 0, 0, 13882);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1022, Current, 13882);
	RTIV(Current, RTAL);
	RTHOOK(1);
