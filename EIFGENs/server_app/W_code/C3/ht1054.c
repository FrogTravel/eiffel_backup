...
extern void F1054_8326(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1054_8327(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#ifndef INLINE_F1054_8327
static EIF_INTEGER_32 inline_F1054_8327 (EIF_OBJECT arg1)
{
	return (EIF_INTEGER_32) (RTS_PID(eif_access(arg1)))
	;
}
#define INLINE_F1054_8327
#endif
...
void F1054_8326 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1053, Current, 1, 1, 14378);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1053, Current, 14378);
	RTCC(arg1, 1053, l_feature_name, 1, eif_new_type(225, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	if (
		...
		RTHOOK(4);
		ur1 = RTCCL(Current);
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6056, dtype))(Current, ur1x)).it_i4);
		ui4_1 = ti4_1;
...
EIF_TYPED_VALUE F1054_8327 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1053, Current, 0, 1, 14379);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1053, Current, 14379);
	...
	RTIV(Current, RTAL);
	{
		...
		Result = inline_F1054_8327 ((EIF_OBJECT) larg1);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
