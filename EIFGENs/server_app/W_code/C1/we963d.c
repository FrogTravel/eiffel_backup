...
static const EIF_TYPE_INDEX egt_13_963 [] = {0xFF01,225,0xFFFF};
...
static const struct desc_info desc_963[] = {
	...
	{EIF_NON_GENERIC(0x01AB /*213*/), 13292, 8},
	{EIF_GENERIC(egt_13_963), 13293, 0},
	{EIF_GENERIC(egt_14_963), 13294, 0xFFFFFFFF},
};
void Init963(void)
{
	IDSC(desc_963, 0, 962);
	IDSC(desc_963 + 1, 1, 962);
	IDSC(desc_963 + 32, 460, 962);
}
