...
extern EIF_TYPED_VALUE F971_7153(EIF_REFERENCE);
extern EIF_TYPED_VALUE F971_7154(EIF_REFERENCE);
extern EIF_TYPED_VALUE F971_7155(EIF_REFERENCE);
extern EIF_TYPED_VALUE F971_7156(EIF_REFERENCE);
extern EIF_TYPED_VALUE F971_7157(EIF_REFERENCE);
extern EIF_TYPED_VALUE F971_7158(EIF_REFERENCE);
extern EIF_TYPED_VALUE F971_7159(EIF_REFERENCE);
extern EIF_TYPED_VALUE F971_7160(EIF_REFERENCE);
...
EIF_TYPED_VALUE F971_7153 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F971_7153,13347,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F971_7154)
EIF_TYPED_VALUE F971_7154 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 970, Current, 0, 0, 13347);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(970, Current, 13347);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F971_7155)
EIF_TYPED_VALUE F971_7155 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 970, Current, 0, 0, 13348);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(970, Current, 13348);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000107, 0,0); /* Result */
...
RTOID (F971_7156)
EIF_TYPED_VALUE F971_7156 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 970, Current, 0, 0, 13349);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(970, Current, 13349);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000107, 0,0); /* Result */
...
RTOID (F971_7157)
EIF_TYPED_VALUE F971_7157 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 970, Current, 0, 0, 13350);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(970, Current, 13350);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000107, 0,0); /* Result */
...
EIF_TYPED_VALUE F971_7158 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F971_7158,13352,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F971_7159 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F971_7159,13353,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F971_7160 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F971_7160,13354,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit971 (void)
{
	GTCX
	RTOTS (7153,F971_7153)
	RTOTS (7154,F971_7154)
	RTOTS (7155,F971_7155)
	RTOTS (7156,F971_7156)
	RTOTS (7157,F971_7157)
	RTOTS (7158,F971_7158)
	RTOTS (7159,F971_7159)
	RTOTS (7160,F971_7160)
}
