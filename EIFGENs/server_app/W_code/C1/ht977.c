...
extern void F977_7194(EIF_REFERENCE);
extern EIF_TYPED_VALUE F977_7196(EIF_REFERENCE);
extern EIF_TYPED_VALUE F977_7197(EIF_REFERENCE);
extern EIF_TYPED_VALUE F977_7198(EIF_REFERENCE);
extern EIF_TYPED_VALUE F977_7199(EIF_REFERENCE);
extern EIF_TYPED_VALUE F977_7200(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F977_7201(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F977_7202(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F977_7203(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F977_7194 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 976, Current, 0, 0, 13375);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(976, Current, 13375);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F977_7196 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F977_7197 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F977_7198 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F977_7199 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F977_7200 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 976, Current, 0, 1, 13380);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(976, Current, 13380);
	if (arg1) {
		RTCC(arg1, 976, l_feature_name, 1, eif_new_type(225, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F977_7201 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 976, Current, 1, 1, 13381);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(976, Current, 13381);
	RTCC(arg1, 976, l_feature_name, 1, eif_new_type(225, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5057, 0xF80000E1, 0); /* variant_value */
	RTAR(Current, arg1);
...
void F977_7202 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 976, Current, 0, 1, 13382);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(976, Current, 13382);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5058, 0x04000000, 1); /* is_acceptable */
	*(EIF_BOOLEAN *)(Current + RTWA(5058, dtype)) = (EIF_BOOLEAN) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
void F977_7203 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 976, Current, 1, 1, 13383);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5056, 0xF800010D, 0); /* supported_variants */
	RTAR(Current, arg1);
