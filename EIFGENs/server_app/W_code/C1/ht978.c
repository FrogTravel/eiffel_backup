...
extern void F978_7204(EIF_REFERENCE);
...
void F978_7204 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 977, Current, 0, 0, 13384);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(977, Current, 13384);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5055, 0xF80000E1, 0); /* vary_header_value */
	...
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5055, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
