...
extern EIF_TYPED_VALUE F967_7130(EIF_REFERENCE);
extern EIF_TYPED_VALUE F967_7131(EIF_REFERENCE);
...
EIF_TYPED_VALUE F967_7130 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 966, Current, 0, 0, 13331);
	RTSA(Dtype(Current));
	RTSC;
...
RTOID (F967_7131)
EIF_TYPED_VALUE F967_7131 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 966, Current, 0, 0, 13332);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 966, Current, 1, 1, 13333);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg1) {
		RTCC(arg1, 966, l_feature_name, 1, eif_new_type(1151, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		RTHOOK(3);
		RTDBGAL(Current, 1, 0xF800047F, 0, 0); /* loc1 */
		loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4999, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	}
	RTHOOK(4);
	...
	ur1 = RTCCL(tr1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(7578, "definite_duration", loc1))(loc1, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(4,1);
	ti8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6279, "seconds_count", tr1))(tr1)).it_i8);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 966, Current, 1, 1, 13334);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(7578, "definite_duration", loc1))(loc1, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(4,1);
	tr8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6280, "fine_seconds_count", tr1))(tr1)).it_r8);
...
#define ui4_1 ui4_1x.it_i4
	...
	if (RTAL & CK_ENSURE) {
		...
		ur1 = RTCCL(Result);
		ti8_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5001, dtype))(Current, ur1x)).it_i8);
