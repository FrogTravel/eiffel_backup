...
extern void F1196_10559(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1196_10560(EIF_REFERENCE);
...
void F1196_10559 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1195, Current, 0, 2, 16576);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1195, Current, 16576);
	RTCC(arg1, 1195, l_feature_name, 1, eif_new_type(1189, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	ur8_1 = tr8_1;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(7605, 1170))(Current, up1x, ui4_1x, ur8_1x)).it_i4);
	ui4_1 = ti4_1;
...
EIF_TYPED_VALUE F1196_10560 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL64;
	r.it_r8 = *(EIF_REAL_64 *)(Current + RTWA(7945,Dtype(Current)));
	return r;
}
