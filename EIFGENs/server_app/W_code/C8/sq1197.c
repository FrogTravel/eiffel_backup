...
extern void F1197_10561(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1197_10562(EIF_REFERENCE);
...
void F1197_10561 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1196, Current, 1, 2, 16578);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1196, Current, 16578);
...
body:;
	...
	if ((EIF_BOOLEAN) (ti8_1 <= ti8_2)) {
		...
		ui4_2 = ti4_1;
		loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(7606, 1170))(Current, up1x, ui4_1x, ui4_2x)).it_i4);
	} else {
		RTHOOK(8);
		RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
		tp1 = *(EIF_POINTER *)(arg1 + RTVA(7913, "internal_stmt", arg1));
		...
		ti8_1 = *(EIF_INTEGER_64 *)(Current + RTWA(7940, dtype));
		ui8_1 = ti8_1;
		loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(7607, 1170))(Current, up1x, ui4_1x, ui8_1x)).it_i4);
	}
	RTHOOK(9);
	ui4_1 = loc1;
...
EIF_TYPED_VALUE F1197_10562 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT64;
	r.it_i8 = *(EIF_INTEGER_64 *)(Current + RTWA(7946,Dtype(Current)));
	return r;
}
