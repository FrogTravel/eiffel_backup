...
extern void F1195_10557(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1195_10558(EIF_REFERENCE);
...
void F1195_10557 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1194, Current, 1, 2, 16574);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1194, Current, 16574);
	RTCC(arg1, 1194, l_feature_name, 1, eif_new_type(1189, 0x01), 0x01);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1195_10558 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
