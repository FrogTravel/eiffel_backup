...
extern void F1074_8718(EIF_REFERENCE);
...
void F1074_8718 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1073, Current, 2, 0, 14754);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1073, Current, 14754);
	RTIV(Current, RTAL);
	if (
		WDBG(1073,"dbglog")
	) {
		...
		if (tb1) {
			...
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3278, "descriptor", loc2))(loc2)).it_i4);
			RTNHOOK(2,1);
			tr1 = c_outi(ti4_1);
