...
extern void F1005_7608(EIF_REFERENCE);
extern void F1005_7609(EIF_REFERENCE);
...
void F1005_7608 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1004, Current, 0, 0, 13719);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1004, Current, 13719);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1005_7609 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1004, Current, 0, 0, 13720);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1004, Current, 13720);
	RTIV(Current, RTAL);
	RTHOOK(1);
