...
extern EIF_TYPED_VALUE F1015_7694(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1015_7695(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1015_7696(EIF_REFERENCE);
extern void F1015_7697(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F1015_7694 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1014, Current, 1, 0, 13799);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1014, Current, 13799);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(2);
	tp1 = *(EIF_POINTER *)(loc1 + RTVA(3029, "item", loc1));
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5502, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
RTOID (F1015_7695)
EIF_TYPED_VALUE F1015_7695 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1014, Current, 0, 0, 13800);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1014, Current, 13800);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {557,204,0xFFFF};
		EIF_TYPE typres0;
...
EIF_TYPED_VALUE F1015_7696 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1014, Current, 0, 0, 13801);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
void F1015_7697 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1014, Current, 0, 1, 13802);
	RTSA(Dtype(Current));
	RTSC;
