...
static const EIF_TYPE_INDEX egt_13_1020 [] = {0xFF01,971,0xFFFF};
...
void Init1020(void)
{
	...
	IDSC(desc_1020 + 32, 523, 1019);
	IDSC(desc_1020 + 36, 524, 1019);
	IDSC(desc_1020 + 42, 482, 1019);
	IDSC(desc_1020 + 51, 480, 1019);
}
