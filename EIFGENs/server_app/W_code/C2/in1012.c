...
extern EIF_TYPED_VALUE F1012_7684(EIF_REFERENCE);extern EIF_BOOLEAN en_ipv6_available();

extern EIF_TYPED_VALUE F1012_7685(EIF_REFERENCE);extern EIF_BOOLEAN en_get_prefer_ipv4();
...
EIF_TYPED_VALUE F1012_7684 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1011, Current, 0, 0, 13792);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1011, Current, 13792);
...
EIF_TYPED_VALUE F1012_7685 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1011, Current, 0, 0, 13793);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1011, Current, 13793);
...
void F1012_7686 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 1011, Current, 0, 1, 13794);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(1011, Current, 13794);
